...
{
    /// <inheritdoc />
    public partial class AuthPlansOwnership : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ReservedMinutes = table.Column<double>(type: "double precision", nullable: false),
                    AnalyzedMinutes = table.Column<double>(type: "double precision", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_PlanEntitlements", x => new { x.PlanId, x.Feature });
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_UsageRecords_AnalysisJobId",
                table: "UsageRecords",
                column: "AnalysisJobId",
                unique: true);

            migrationBuilder.CreateIndex(
                name: "IX_UsageRecords_UserId_StartedAt",
                table: "UsageRecords",
